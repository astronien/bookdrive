...
- [x] เชื่อม Calibre library ผ่าน Google Picker → สแกนแบบ batch → อ่าน metadata.opf
      (เล่มที่ไม่มี opf จะแกะ metadata จากไฟล์ EPUB เองเพื่อกู้ชื่อไทยที่ Calibre ถอดเป็นอักษรโรมันไว้)
...
- [x] PWA + service worker — ติดตั้งลงจอโฮมและอ่านออฟไลน์ได้
- [x] กรองตามสถานะ/ผู้เขียน/แท็ก/ออฟไลน์ + เรียง 6 แบบ
- [x] เตือนก่อน session หมดอายุ
- [ ] CBZ/CBR, TTS
- ~~MOBI/AZW3 reader~~ — สำรวจแล้วไม่มีเล่มไหนมี MOBI อย่างเดียว ไม่ต้องทำ
